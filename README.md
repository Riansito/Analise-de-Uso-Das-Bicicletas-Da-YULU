...
Com isso, o projeto fornece **insights acionáveis** para otimizar o uso da frota, planejar operações e melhorar a experiência dos usuários de bicicletas elétricas da Yulu. Para saber mais das Análises feitas, vá na pasta Notebooks onde terá todo o processo da análise exploratoria dos dados, apresentando as descobertas e estratégias.
